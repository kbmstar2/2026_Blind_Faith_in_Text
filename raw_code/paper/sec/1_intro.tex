...
We compare DPO against GRPO-style sampled-answer optimization, preservation SFT, model transfer, and dataset transfer.
...
\begin{itemize}[leftmargin=*]
    ...
    \item We compare DPO, GRPO, SFT preservation, multi-condition error mining, and model transfer, clarifying when preference optimization helps and when it does not.
\end{itemize}
