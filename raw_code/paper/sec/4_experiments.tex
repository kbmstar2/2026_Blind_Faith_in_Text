...
\subsection{SFT Preservation Ablation}

We also test whether adding supervised fine-tuning (SFT) anchors can preserve non-corrupted behavior.
SFT is a plausible baseline because it directly teaches the model to output correct answers.
...
Thus, in our experiments, SFT acts as a negative preservation ablation rather than the main mitigation method.
